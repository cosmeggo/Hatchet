...
SMODS.Consumable {
    ...
    loc_vars = function(self, info_queue, card)
        return { vars = { card.ability.extra.sephirots, card.ability.extra.daat } }
    end,
...
SMODS.Consumable {
    ...
    set = 'hatch_sephirot',
    pos = { x = 1, y = 0 },
    config = { max_highlighted = 2, mod_conv = 'm_hatch_sulfur' },
    cost = 3,
    atlas = 'HatchetConsumables',
...
SMODS.Consumable {
    ...
    set = 'hatch_sephirot',
    pos = { x = 2, y = 0 },
    config = { max_highlighted = 2, mod_conv = 'm_hatch_mercury' },
    cost = 3,
    atlas = 'HatchetConsumables',
...
SMODS.Consumable {
    ...
    set = 'hatch_sephirot',
    pos = { x = 8, y = 0 },
    config = { max_highlighted = 1, mod_conv = 'm_hatch_salt' },
    cost = 3,
    atlas = 'HatchetConsumables',
